...
// 	  block the signal, and then call it to process (Generally from 
// 	  the main thread). Note that only one thread can receive.
...
// used to simulate `signalfd`.
//
// It can handle all signals except SIGKILL, SIGSTOP.
