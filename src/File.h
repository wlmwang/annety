...
public:
  ...
  File(const StringPiece& path, uint32_t flags);
  ...
  // Creates or opens the given file.
  void initialize(const StringPiece& path, uint32_t flags);
...
private:
  ...
  void do_initialize(const StringPiece& path, uint32_t flags);
